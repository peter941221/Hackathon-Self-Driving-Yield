...
def render_one_pager_svg(baseline_report, stress_report, output_path):
    ...
    lines = [
        ...
        '<rect x="544" y="154" width="220" height="56" rx="16" fill="#7c3aed"/><text x="654" y="189" text-anchor="middle" fill="#f5f3ff" font-size="22" font-weight="700">Tests 54 / 54</text>',
        ...
        '<rect x="1024" y="154" width="220" height="56" rx="16" fill="#be123c"/><text x="1134" y="189" text-anchor="middle" fill="#fff1f2" font-size="22" font-weight="700">Formal 8 / 8</text>',
        ...
        '<text x="64" y="480" fill="#e2e8f0" font-size="18">• 5/5 invariants, 8/8 symbolic formal properties, and one remaining callback event-order warning in Slither.</text>',
        ...
        '<text x="738" y="752" fill="#e2e8f0" font-size="18">• The repo now shows reproducible research plus tests, formal proofs, and manual review focus.</text>',
        '<text x="738" y="784" fill="#e2e8f0" font-size="18">• Remaining audit focus is concentrated in the flash callback path, not spread across the system.</text>',
