...
def render_one_pager_svg(baseline_report, stress_report, output_path):
    ...
    lines = [
        ...
        '<rect x="1024" y="154" width="220" height="56" rx="16" fill="#be123c"/><text x="1134" y="189" text-anchor="middle" fill="#fff1f2" font-size="22" font-weight="700">Formal 9 / 9</text>',
        ...
        '<text x="64" y="480" fill="#e2e8f0" font-size="18">• 5/5 invariants, 9/9 symbolic formal properties, and one remaining callback event-order warning in Slither.</text>',
