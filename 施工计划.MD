...
- [ ] 架构图覆盖 Vault / Adapters / Oracle / Queue
...
- [ ] EngineVault: ERC-4626 接口齐全

- [ ] VolatilityOracle: TWAP + 采样窗口可运行

- [ ] Aster1001xAdapter: ABI 精度与字段校验

- [ ] PancakeV2Adapter: add/remove + LP 拆解

- [ ] FlashRebalancer: pancakeCall 安全校验


### Part6 核心算法

- [ ] 动态配比 (Regime Switching) 正常工作

- [ ] Delta 对冲逻辑回到 band 内

- [ ] Flash Rebalance 单笔完成再平衡

- [ ] Bounty 公式包含 gasPrice cap + buffer cap (OpenCode 补充)
...
- [ ] cycle() 按 Phase 0-6 完整执行

- [ ] 冷启动 (MIN_SAMPLES) 时 Regime = NORMAL (OpenCode 补充)

- [ ] snapshot 采样间隔受 minSnapshotInterval 限制

- [ ] claimWithdraw 支持 partial claim + bounty 激励 (OpenCode 补充)
...
- [ ] MEV 防护: slippage + deadline + Flash

- [ ] 风险分层与熔断规则可验证

- [ ] ONLY_UNWIND 模式落地与解除条件明确 (OpenCode 补充)


### Part9 经济模型与收益模拟

- [ ] 三场景 (CALM/NORMAL/STORM) 收益模拟完备

- [ ] Sharpe Ratio 估算合理

- [ ] 敏感性/压力测试包含 fee / funding / gas / 单边行情 (OpenCode 补充)
