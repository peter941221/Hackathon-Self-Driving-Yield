...
- [x] Design Prompts (Hedging / Volatility / Resilience) 有对应解法
...
- [x] 链上地址与关键参数可验证 (ChainChecks 已记录, fee/INIT_CODE_HASH 已确认)
...
- [x] slither 已运行，warnings 记录在 `docs/SLITHER_NOTES.md`
...
- [x] README 中完整呈现 Why/What/How/Assumptions/Sustainability/Resilience


### 附录 B 关键参考

- [x] 关键地址与费用参数链上核对完毕 (INIT_CODE_HASH + V2 fee)


### 附录 C 差异总结

- [x] 差异矩阵与 OpenCode 补充项一致
